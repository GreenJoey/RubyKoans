...
class AboutRegularExpressions < Neo::Koan
  ...
  # Because they have to get the most characters ot from the string that matches
  # the pattern
  ...
  # class ([...]) is used when we want to match a character within some group
  # alternation (|) is used when we want to match either of one the class-es
