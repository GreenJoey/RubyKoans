...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It starts with a default and applies a running operation
    # on the collection
  end
  ...
  # It is a easy way to work with files as a context
  # Also it keeps automates the open() and close() close
